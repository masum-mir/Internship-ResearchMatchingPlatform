...
export default function InternshipApplicants() {
  ...
  const load = () => {
    setLoading(true);
    applicationApi.internshipApplicants(id).then(setItems)
  ...
  return (
    <div>
      <Link to="/company/internships" className="btn btn-sm btn-light mb-3"><i className="bi bi-arrow-left me-1" /> Back</Link>
